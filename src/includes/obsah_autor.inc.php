            ...
            if ($result->num_rows >0){
                ...
                while ($row = $result->fetch_assoc()){
                    ...
                    echo "<tr><td><a href='./pdf/".$row["soubor"]."'>" . $row["nazev"] ."</a></td> <td> " .$row["tema"]. " </td> 
                           <td> ".$row["datum"]. " </td> <td> ".$row["stav_slovy"]. " </td> <td> ".$row["spoluautori"]."</td><td><a class='btn-add-article rec' data-toggle='modal' data-target='#recenzeModal' data-hod1='".$row["r1_hod1"]."' data-hod2='".$row["r1_hod2"]."' data-hod3='".$row["r1_hod3"]."' data-hod4='".$row["r1_hod4"]."' data-hod5='".$row["r1_hod5"]."' data-hod6='".$row["r1_hod6"]."' data-text='".$row["r1_text"]."'>".$row["recenzent_jmeno"]." ".$row["recenzent_prijmeni"]."</a></td><td><a class='btn-add-article rec' data-toggle='modal' data-target='#recenzeModal' data-hod1='".$row["r2_hod1"]."' data-hod2='".$row["r2_hod2"]."' data-hod3='".$row["r2_hod3"]."' data-hod4='".$row["r2_hod4"]."' data-hod5='".$row["r2_hod5"]."' data-hod6='".$row["r2_hod6"]."' data-text='".$row["r2_text"]."'>".$row["recenzent2_jmeno"]." ".$row["recenzent2_prijmeni"]."</a></td></tr>";
                }
                echo "</table>";
